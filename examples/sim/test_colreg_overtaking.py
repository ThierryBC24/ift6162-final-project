"""
Test COLREG Rule 13: Overtaking encounter.
Own ship overtakes slower traffic vessel.
Own ship must keep clear.
"""
...
def main():
    ...
    # Overtaking: own ship overtakes slower traffic vessel
    # Traffic ahead, slower, same direction
    traffic_ship = make_vessel_at_xy(
        env, x=2000.0, y=0.0, psi=0.0, v=2.0, max_yaw_rate_deg=traffic_max_yaw_rate
    )
    ...
    if args.animate:
        out_path = Path(__file__).resolve().parent / "test_colreg_overtaking.gif"
